...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        yield defineElements();
    });
}
function defineElements() {
    return __awaiter(this, void 0, void 0, function* () {
        yield ApplicationContainer.define();
        yield TopPanel.define();
        yield SettingsPanel.define();
        yield UploadsPanel.define();
        yield UploadProgressPanel.define();
    });
}
init();
